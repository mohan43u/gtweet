...
#define T_S_STAT_FILTER "https://stream.twitter.com/1/statuses/filter.json"
#define T_S_STAT_SAMPLE "https://stream.twitter.com/1/statuses/sample.json"
#define T_S_STAT_FIREHOSE "https://stream.twitter.com/1/statuses/firehose.json"
#define T_S_USER "https://userstream.twitter.com/2/user.json"
#define T_R_TIMELINE "https://api.twitter.com/1/statuses/home_timeline.json"
#define T_R_USERSETTINGS "https://api.twitter.com/1/account/settings.json"
#define T_R_TRENDS "https://api.twitter.com/1/trends/%s.json"
